...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] float superSpeedMoveControl; // Tätä käytetään argumenttina PlayerIsMovingSuperSpeed-funktiossa.
    ...
    float PlayerIsMovingSuperSpeed(float speed) //<-- Lisää tähän mikä vain muuttuja tyyppiä float.Voit myös antaa arvon tässä
    {
